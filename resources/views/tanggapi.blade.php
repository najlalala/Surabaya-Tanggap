...
<style>
    ...
    .line-border-input select:focus {
...
@section('content')
    ...
    <div class="card-3d">
        <div class="card-3d-content">
            ...
            <p><strong>Status:</strong> <span id="status">Diproses</span></p>
    ...
    <div class="mb-4">
        ...
        <form action="#" method="POST">
            ...
            <div class="line-border-input mb-3">
                ...
                <textarea class="form-control" id="tanggapan" name="tanggapan" rows="5" placeholder="Masukkan tanggapan Anda di sini..." required></textarea>
            </div>
